...
![Training Accuracy](./grafik.png) 
*(Not: Buraya kaydettiğin grafik dosyasının adını yaz)*
...
## 👥 Geliştiriciler
* [Senin Adın](https://github.com/senin-kullanici-adin)
* [Arkadaşının Adı](https://github.com/arkadasinin-kullanici-adi)
